...
const initialAgents: Agent[] = [
  // Invoice Agents
  {
    ...
    description: "Cria faturas automaticamente baseado em contratos e serviços recorrentes",
    icon: FileText,
    category: "invoices",
    enabled: true,
    status: "active",
  ...
  },
  {
    ...
    description: "Envia lembretes automáticos para clientes com faturas próximas do vencimento",
    icon: Bell,
    category: "invoices",
    enabled: true,
    status: "active",
  ...
  },
  {
    ...
    description: "Reconcilia pagamentos recebidos com faturas emitidas automaticamente",
    icon: FileCheck,
    category: "invoices",
    enabled: false,
    status: "idle",
  ...
  // Support Agents
  {
    ...
    description: "Responde dúvidas frequentes dos clientes via chat automaticamente",
    icon: MessageSquare,
    category: "support",
    enabled: true,
    status: "active",
  ...
  },
  {
    ...
    description: "Classifica e prioriza tickets de suporte automaticamente",
    icon: HeadphonesIcon,
    category: "support",
    enabled: true,
    status: "active",
  ...
  },
  {
    ...
    description: "Escala tickets críticos para especialistas quando necessário",
    icon: AlertTriangle,
    category: "support",
    enabled: false,
    status: "idle",
  ...
  // Report Agents
  {
    ...
    description: "Gera e envia relatórios diários de performance financeira",
    icon: BarChart3,
    category: "reports",
    enabled: true,
    status: "active",
  ...
  },
  {
    ...
    description: "Analisa dados e identifica tendências e oportunidades",
    icon: TrendingUp,
    category: "reports",
    enabled: true,
    status: "learning",
  ...
  },
  {
    ...
    description: "Verifica conformidade com regulamentações fiscais automaticamente",
    icon: FileSearch,
    category: "reports",
    enabled: false,
    status: "idle",
  ...
  // Finance Agents
  {
    ...
    description: "Projeta fluxo de caixa baseado em histórico e contratos",
    icon: Calculator,
    category: "finance",
    enabled: true,
    status: "active",
  ...
  },
  {
    ...
    description: "Processa e valida pagamentos recebidos automaticamente",
    icon: CreditCard,
    category: "finance",
    enabled: true,
    status: "active",
  ...
  },
  {
    ...
    description: "Identifica e gerencia contas inadimplentes com ações automáticas",
    icon: Clock,
    category: "finance",
    enabled: false,
    status: "idle",
  ...
  // Automation Agents
  {
    ...
    description: "Envia campanhas de email personalizadas para clientes",
    icon: Mail,
    category: "automation",
    enabled: false,
    status: "idle",
  ...
  },
  {
    ...
    description: "Agenda reuniões e compromissos automaticamente",
    icon: Calendar,
    category: "automation",
    enabled: true,
    status: "active",
  ...
  },
  {
    ...
    description: "Automatiza o processo de cadastro e boas-vindas de novos clientes",
    icon: Users,
    category: "automation",
    enabled: true,
    status: "learning",
  ...
  },
  {
    ...
    description: "Executa fluxos de trabalho complexos baseados em gatilhos",
    icon: Zap,
    category: "automation",
    enabled: true,
    status: "active",
      ...
      prev.map((agent) =>
        agent.id === id
          ? {
              ...
              actionsToday: !agent.enabled ? agent.actionsToday : 0,
            }
          : agent
      )
    );
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              Gerencie automações inteligentes para sua contabilidade
            </p>
          </div>
                      ...
                      {agent.enabled && agent.actionsToday > 0 && (
                        <div className="mt-3 pt-3 border-t border-border">
                          <span className="text-xs text-muted-foreground">
                            {agent.actionsToday} ações realizadas hoje
                          </span>
                        </div>
                      )}
                    </CardContent>
